(define (problem test)
    ...
    (:goal (and (or (on  apple0 table0) (on  apple0 counter1) (on  apple0 counter2)) (or (on  coke0 table0) (on  coke0 counter1) (on  coke0 counter2)) (or (on  water0 table0) (on  water0 counter1) (on  water0 counter2))))
