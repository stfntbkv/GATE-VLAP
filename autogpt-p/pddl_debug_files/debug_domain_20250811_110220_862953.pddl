(define (domain robotic_planning)
    ...
    (:types
        ...
        robot human heat_liquider take_outer choper pourer moveer closeer receive_objecter opener filler handoverer grasper wet_swipeer placeer putiner stacker - actor
