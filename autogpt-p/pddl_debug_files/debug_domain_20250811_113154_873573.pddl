(define (domain robotic_planning)
    ...
    (:types
        ...
        robot human stacker pourer opener choper take_outer closeer filler heat_liquider receive_objecter handoverer grasper putiner placeer wet_swipeer moveer - actor
