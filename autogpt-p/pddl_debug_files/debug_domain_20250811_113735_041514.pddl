(define (domain robotic_planning)
    ...
    (:types
        ...
        robot human pourer receive_objecter heat_liquider putiner moveer placeer handoverer grasper stacker filler opener choper wet_swipeer closeer take_outer - actor
        lime_soda apple trash_can red_bull tea energy_bar sponge multigrain_chips grapefruit_soda water jalapeno_chips - grasp
        lime_soda apple trash_can red_bull tea energy_bar sponge multigrain_chips grapefruit_soda water jalapeno_chips - carry
        lime_soda trash_can red_bull tea sponge grapefruit_soda water - contain
        lime_soda red_bull grapefruit_soda water - liquid-contain
        lime_soda water - enclosed-contain
        lime_soda red_bull grapefruit_soda water - pour
        lime_soda red_bull grapefruit_soda water - drink
        lime_soda counter apple trash_can red_bull tea energy_bar sponge multigrain_chips table grapefruit_soda water jalapeno_chips - rotate
        lime_soda apple red_bull tea energy_bar sponge grapefruit_soda water - axis-roll
        lime_soda apple trash_can red_bull tea energy_bar sponge multigrain_chips table grapefruit_soda water jalapeno_chips - push
        lime_soda apple trash_can red_bull tea energy_bar sponge multigrain_chips table grapefruit_soda water jalapeno_chips - pull
        lime_soda trash_can red_bull grapefruit_soda water - open
        lime_soda trash_can grapefruit_soda water - close
        lime_soda red_bull grapefruit_soda water - stir
        counter table - support
        counter trash_can red_bull energy_bar sponge multigrain_chips grapefruit_soda jalapeno_chips - stack
        counter trash_can table - vertical-support
        apple - free-roll
        apple red_bull tea energy_bar multigrain_chips grapefruit_soda jalapeno_chips - consumable
        tea - liquid
        tea - drinkable
        sponge - wet-swipe
