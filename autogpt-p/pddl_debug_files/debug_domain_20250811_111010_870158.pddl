(define (domain robotic_planning)
    ...
    (:types
        ...
        robot human putiner receive_objecter choper pourer heat_liquider wet_swipeer handoverer placeer grasper filler take_outer moveer stacker opener closeer - actor
