(define (domain robotic_planning)
    ...
    (:types
        ...
        robot human moveer take_outer filler opener wet_swipeer putiner choper heat_liquider closeer grasper stacker receive_objecter placeer pourer handoverer - actor
