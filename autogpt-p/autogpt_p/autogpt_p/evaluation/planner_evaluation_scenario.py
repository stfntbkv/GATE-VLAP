...
class PlannerEvaluationScenario:
    """

    """

    def __init__(self, scene: SimulatedScene, user_task: str, goal_state: LogicElement, min_costs: int):
        """
    ...
    def evaluate_planner(self, planner: AutoGPTPlanner) -> Tuple[bool, int, float, float, float, bool, float]:
        ...
        end_time = time.time()
        print(f"DEBUG: Total evaluation took {end_time - start_time:.2f} seconds")
